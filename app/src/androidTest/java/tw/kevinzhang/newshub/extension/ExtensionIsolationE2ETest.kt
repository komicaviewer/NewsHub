    ...
    private companion object {
        ...
        val SOURCE_POLICIES = listOf(
            TestSourcePolicy(
                ...
                policy(
                    requestRules = listOf(
                        requestRule("eyny.com", "www.eyny.com", credentialed = true),
                    ),
                    resourceHosts = hosts("eyny.com", "www.eyny.com"),
                    externalHosts = hosts("eyny.com", "www.eyny.com"),
                    authHosts = hosts("eyny.com", "www.eyny.com"),
        ...
        val PUBLISHED_POLICY_HASHES = mapOf(
            "tw.kevinzhang.eyny" to "5206b958aa3148385f5ac40a3c9c51c3dd539d47505557ccabde8e845453279a",
