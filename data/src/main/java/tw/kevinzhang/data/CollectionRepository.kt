...
interface CollectionRepository {
    ...
    suspend fun addBoardSubscription(collectionId: String, sourceKey: String, boardUrl: String, boardName: String)
    suspend fun removeBoardSubscription(subscriptionId: String)
    suspend fun removeAllSubscriptionsForSource(sourceKey: String)
}
